...
class MailUtils {
  MailUtils._();
  // void bulkEmailDialog(FocusNode focusNode, {required List<NewLeadObj> list, bool isTarget = false}) {
  ...
  void bulkEmailDialog(FocusNode focusNode, {required List<NewLeadObj> list, bool isTarget = false}) {
    ...
    imageController.photo1.value="";
    int total = list.length;
    int withMail = list.where((e) => (e.email != null && e.email!.trim().isNotEmpty && e.email!.trim() != "null")).length;
    int withoutMail = total - withMail;
    var selectedRange = "".obs;
    void selectRange(String range, List<NewLeadObj> allLeads) {
      selectedRange.value = range;
                          ...
                          children: [
                            ...
                            Obx(() => CustomLoadingButton(
                              callback: () {
                                ...
                                List<Map<String, String>> withMail = controllers.allLeadList
                                    .where((e) {
                                  final mail = e.email;
                                  return mail != null && mail.trim().isNotEmpty && mail.trim() != "null";
                                })
