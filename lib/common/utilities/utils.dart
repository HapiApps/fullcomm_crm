...
class Utils {
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          KeyboardDropdownField2<AllCustomersObj>(
                            items: controllers.customers,
                            borderRadius: 5,
                            borderColor: Colors.grey.shade400,
                            hintText: "Search leads / customers",
                            labelBuilder: (customer) =>customer.email,
                            itemBuilder: (customer) {
                              return Container(
                                alignment: Alignment.centerLeft,
                                padding: const EdgeInsets.symmetric(horizontal: 10),
                                child: CustomText(
                                  text:'${customer.name} - ${customer.email} - ${customer.category}',
                                  size: 14,
                                  isCopy: false,
                                ),
                              );
                            ...
                            onSelected: (value) {
                              setState((){
                                if(value.email.toString()=="null"||value.email.toString()==""){
                                  controllers.emailToCtr.clear();
                                  showToast("No Email Provided", Colors.red);
                                }else{
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                ...
                                //   ),
                                // ),
                                child: KeyboardDropdownField2<AllCustomersObj>(
                                  items: controllers.customers
                                      .where((c) =>
                                  c.email != null &&
                                      c.email.toString().trim().isNotEmpty &&
                                      c.email.toString() != "null")
                                      .toList(),
                                  ...
                                  onSelected: (value) {
                                    setState(() {
                                      controllers.emailToCtr.text = value.email ?? "";
                                    });
                                    controllers.selectCustomer(value);
                                  },
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: KeyboardDropdownField2<AllCustomersObj>(
                                  items: controllers.customers.where((c) =>c.email != null &&c.email.toString().trim().isNotEmpty &&c.email.toString() != "null").toList(),
                                  borderRadius: 5,
                                  borderColor: Colors.grey.shade400,
                                  labelBuilder: (customer) => customer.email,
                                  itemBuilder: (customer) {
                                    final isSelected = controllers.selectedCustomers.contains(customer);
                                    return StatefulBuilder(
                                      builder: (context, setInnerState) {
                                        return InkWell(
                                          onTap: () {
                                            setInnerState(() {
                                              if (isSelected) {
                                                controllers.selectedCustomers.remove(customer);
                                              } else {
                                                controllers.selectedCustomers.add(customer);
                                              }
                                              controllers.mailers.text = controllers.selectedCustomers
                                                  .map((e) => e.email)
                                                  .join(", ");
                                            });
                                          },
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Expanded(
                                                  child: CustomText(
                                                    text:
                                                    '${customer.name} - ${customer.email} - ${customer.category}',
                                                    size: 14,
                                                    isCopy: false,
                                                  ),
                                                ),
                                  ...
                                  textEditingController: controllers.mailers,

                                  onSelected: (value) {}, // Not needed now
  ...
  void showComposeMail(BuildContext context) {
    ...
    final formatProvider = Provider.of<ReminderProvider>(context, listen: false);
    formatProvider.resetFormatting();
    TextEditingController emailAutoController=TextEditingController();
    showDialog(
      context: context,
      builder: (context) {
        return StatefulBuilder(
                        ...
                        SizedBox(
                          child: Autocomplete<AllCustomersObj>(
                            ...
                            fieldViewBuilder: (context, controller, focusNode, onSubmit) {
                              emailAutoController = controller; // 🔥 store reference
                              return TextField(
                                controller: controller,
                                focusNode: focusNode,
                                decoration: InputDecoration(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      /// 🔹 TO
                      buildEmailField(label: "To", emailList: toEmails),
                      SizedBox(height: 10),

                      /// 🔹 CC
                      buildEmailField(label: "Cc", emailList: ccEmails),
                      SizedBox(height: 10),
                      ...
                      Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              setState((){
                                formatProvider.toggleUnderline();
                              });
                            },
                          ),
                            ...
                            children: [
                              ...
                              CustomLoadingButton(
                                callback: () {
                                  ...
                                  var sendList=[];
                                  sendList.addAll(toEmails);
                                  sendList.addAll(ccEmails);
                                  apiService.insertMultipleEmailAPI(context, sendList, nameList,idList,imageController.photo1.value);
                                },
                                controller: controllers.emailCtr,
                                isImage: false,
                                isLoading: true,
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        onChanged: (value) {
                          ...
                          controllers.firstCaps(value,controllers.meetingTitleCrt);
                        },
                        decoration: InputDecoration(
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        onChanged: (value) {
                          ...
                          // }
                          controllers.firstCaps(value,controllers.meetingVenueCrt);
                        },
                        decoration: InputDecoration(
                            border: OutlineInputBorder(),
                            enabledBorder: OutlineInputBorder(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: TextField(
                            ...
                            maxLines: null,
                            onChanged: (value){
                              controllers.firstCaps(value,controllers.callCommentCont);
                            },
                            minLines: 3,
                            decoration: InputDecoration(
                              hintText: "Notes",
  ...
  Future<void> datePicker({
    ...
    if (value != null) {
      ...
      if (remController.stDate.value.isNotEmpty &&
          remController.enDate.value.isNotEmpty) {

        DateTime start = DateFormat("dd-MM-yyyy")
            .parse(remController.stDate.value);

        DateTime end = DateFormat("dd-MM-yyyy")
            .parse(remController.enDate.value);

        if (end.isBefore(start)) {
          utils.showToast("End date cannot be before start date", Colors.red);
          remController.enDate.value = "";
          controllers.dateOfConCtr.clear();
          return;
        }
      }
