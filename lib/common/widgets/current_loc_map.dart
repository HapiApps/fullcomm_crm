          ...
          child: TextField(
              ...
              if (searchController.text != "") {
                ...
                try {
                  ...
                  List<Location> locations =
                      await locationFromAddress(searchController.text.trim());
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: GestureDetector(
                        ...
                        _marker.add(
                          Marker(
                            ...
                            position: LatLng(
                                locations[0].latitude, locations[0].longitude),
                            infoWindow:
                                InfoWindow(title: searchController.text),
                            icon: BitmapDescriptor.defaultMarkerWithHue(
                                BitmapDescriptor.hueViolet),
                          ),
                        );
                  ...
                  child: Obx(() => isLoaded.value == false
                      ? Icon(Icons.search, color: colorsConst.primary)
                      : Center(
                          child: CustomText(
                              text: "Loading...",
                              size: 12,
