...
class _SignUpState extends State<SignUp> {
  ...
  void check() async {
    ...
    Future.delayed(Duration.zero, () {
      setState(() {
        controllers.signFirstName.text =
            prefs.getString("sign_first_name") ?? "";
        controllers.signMobileNumber.text =
            prefs.getString("sign_mobile_number") ?? "";
      ...
      child: Scaffold(
        ...
        body: Row(
          children: [
            ...
            Container(
              width: MediaQuery.of(context).size.width <= 987
                            ...
                            CustomTextField(
                              ...
                              onChanged: (value) async {
                                ...
                                sharedPref.setString(
                                    "sign_first_name", value.toString().trim());
                              },
                            ),
                            CustomTextField(
                              text: "Last Name",
                                          ...
                                          () => Checkbox(
                                              ...
                                              onChanged: (value) {
                                                ...
                                                if (controllers
                                                        .isWhatsApp.value ==
                                                    true) {
                                                  controllers.signWhatsappNumber
                                                          .text =
                                                      controllers
                                                          .signWhatsappNumber
                                                          .text;
                            ...
                            CustomPasswordTextField(
                              ...
                              onChanged: (value) async {
                                SharedPreferences sharedPref =
                                    await SharedPreferences.getInstance();
                                sharedPref.setString(
                                    "sign_password", value.toString().trim());
                              },
                            ),
                            15.height,
                            CustomDropDown(
                            ...
                            CustomTextField(
                              ...
                              onChanged: (value) async {
                                SharedPreferences sharedPref =
                                    await SharedPreferences.getInstance();
                                sharedPref.setString(
                                    "sign_referred", value.toString().trim());
                              },
                            ),
                          ],
                        ),
