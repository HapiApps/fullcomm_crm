...
class CustomTextField extends StatefulWidget {
  ...
  const CustomTextField({super.key, required this.text, this.height=70, this.width=270,
    ...
    this.onPressed,this.prefixText,this.onEdit, this.isOptional
  });
...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context){
    return Column(
      ...
      children:[
        widget.hintText!.isEmpty?0.height:utils.textFieldNearText(widget.text,widget.isOptional!),
        SizedBox(
          width: widget.width,
          //height:80,
          child: Center(
