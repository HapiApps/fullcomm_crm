...
class LeadCon extends StatefulWidget {
  ...
  String updateTs;
   LeadCon({super.key,
    ...
    this.linkedin,
    this.x,
    this.quotationStatus, this.productDiscussion,
    this.discussionPoint, this.notes, this.quotationRequired,
    this.arpuValue, this.sourceDetails, this.prospectEnrollmentDate,
    this.expectedConvertionDate, this.statusUpdate, this.numOfHeadcount, this.expectedBillingValue,required this.updateTs
          ...
          child: Column(
            ...
            children:[
              ...
              Row(
                ...
                children:[
                  CustomText(
                    text: widget.mainName=="null"?"":widget.mainName.toString(),
                    isBold: true,
                  ...
                  Obx(() => CustomCheckBox(
                      ...
                      onChanged: (value){
                        setState(() {
                          if(widget.leadStatus=="2"){
                            if(controllers.isLeadsList[widget.index!]["isSelect"]==true){
                              controllers.isLeadsList[widget.index!]["isSelect"]=false;
                              var i=apiService.qualifiedList.indexWhere((element) => element["lead_id"]==widget.id.toString());
                            ...
                            if(controllers.isGoodLeadList[widget.index!]["isSelect"]==true){
                              ...
                              var i=apiService.customerList.indexWhere((element) => element["lead_id"]==widget.id.toString());
                      ...
                      saveValue: widget.leadStatus.toString().trim()=="2"?controllers.isLeadsList.isEmpty?false:controllers.isLeadsList[widget.index!]["isSelect"]:controllers.isGoodLeadList.isEmpty?false:controllers.isGoodLeadList[widget.index!]["isSelect"]),
                  )
                ],
              ),
              CustomText(
              ...
              10.height,
              CustomText(
                text: widget.companyName=="null"?"":widget.companyName.toString(),
                colors: colorsConst.textColor,
                size: 15,
                isBold: true,
              ),
              ...
              10.height,
              widget.emailUpdate==null||widget.emailUpdate.toString().isEmpty?0.height:Row(
                ...
                children:[
                  ...
                  Container(
                    ...
                    child: CustomText(
                      text: widget.emailUpdate.toString().isEmpty||widget.emailUpdate=="null"?
