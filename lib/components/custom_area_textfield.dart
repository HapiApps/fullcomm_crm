...
import '../common/widgets/current_loc_map.dart';
          ...
          child: Center(
            child: TextFormField(
                ...
                decoration:InputDecoration(
                  ...
                  //               //Get.to(DemoMap());
                  //                         Get.to(ViaMap(
                  //                           // lat:double.parse(mapController.latitude.value),
                  //                           // lng:double.parse(mapController.longitude.value),
                  //                           // dNo:widget.dNoC!.text,
                  //                           // street:widget.streetC!.text,
                  //                           // area:widget.areaC!.text,
                  //                           // city:widget.cityC!.text,
                  //                           // state:widget.stateC!,
                  //                           // country:widget.countryC!.text,
                  //                           // pinCode:widget.pinCodeC!.text,
                  //                         )
                  //                         );
                  //             },
