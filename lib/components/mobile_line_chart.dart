...
class MobileDayWiseBarChart extends StatelessWidget {
  const MobileDayWiseBarChart({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final highlightColor = Colors.pinkAccent.shade400;
      final defaultColor = Colors.green;
      final maxY = (report.map((e) => e.totalCustomers).reduce((a, b) => a > b ? a : b) + 5).toDouble();
