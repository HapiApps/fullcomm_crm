            ...
            Positioned(
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: SizedBox(
                    width: 1230>MediaQuery.of(context).size.width-200?1150:MediaQuery.of(context).size.width-200,
                    height: MediaQuery.of(context).size.height,
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        20.height,
                        utils.headingBox(width:MediaQuery.of(context).size.width-200,text:  "All Employees"),
                                ...
                                onPressed: (){
                                  ...
                                  Future.delayed(Duration.zero,()async {
                                    Navigator.push(context,
                                      PageRouteBuilder(
                                        pageBuilder: (context, animation1, animation2) => const AddEmployee(),
                                      ...
                                      child: Column(
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              CustomText(
                                                text: snapshot.data![index].doj.toString(),
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    CustomText(
                                                      text:snapshot.data![index].empId.toString(),
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    CustomText(
                                                      text: snapshot.data![index].phoneNumber.toString(),
                                                      colors:colorsConst.primary,
                                                      size: 13,
                                                      isBold: true,
                                                    ),
                                                    CustomText(
                                                      ...
                                                      text: "${snapshot.data![index].doorNo} ${snapshot.data![index].streetName}\n${snapshot.data![index].area}, ${snapshot.data![index].state}.",
                                                      colors: colorsConst.primary,
                                                      size: 13,
                                                      isBold: true,
                                                    ),
                                                    ...
                                                    CustomText(
                                                      text: "\u{20B9}${snapshot.data![index].salary}",
                                                      colors: colorsConst.primary,
                                                      size: 13,
                                                      isBold: true,
                                                    ),
                                                    CustomText(
                                                      text:snapshot.data![index].managerName.toString(),
                                                      colors: colorsConst.primary,
                                                      size: 13,
                                                      isBold: true,
                                                    ),
