...
class _EmployeeReportPageState extends State<EmployeeReportPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      repCtr.empName.value=widget.name;
      ...
      remController.empCalls(
        allCalls: controllers.callActivity,
        searchText: repCtr.empName.value,
      ...
      remController.searchText.value=repCtr.empName.value;
      remController.empMails(repCtr.empName.value);
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Obx(()=> utils.selectHeatingType2("Total Leads",
                                              controllers.sortLead.value=="", (){
                                                controllers.sortLead.value="";
                                                controllers.filterEmpLeads();
                                              }, Colors.blueAccent,controllers.allCus.value.toString().obs,width: 150),),
                                          10.width,
                                          Obx(()=>utils.selectHeatingType2("Converted to ${controllers.leadCategoryList.last.value}",
                                              controllers.sortLead.value=="Completed", (){
                                                controllers.sortLead.value="Completed";
                                                controllers.filterEmpLeads();
                                              }, Colors.green,controllers.mainCus.value.toString().obs,width: 250),),
                                          10.width,
                                          Obx(()=> utils.selectHeatingType2("In Progress",
                                              controllers.sortLead.value=="Pending", (){
                                                controllers.sortLead.value="Pending";
                                                controllers.filterEmpLeads();
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          10.width,
                                          Obx(()=> utils.selectHeatingType2("Total Value",
                                              ""=="", (){
                                              }, Colors.lightGreen,productCtr.formatAmount(productCtr.quotationValue.value.toString()).obs,width: 250),),
                                        ],
                                      ),
                                      InkWell(
                                          onTap: (){
                                  ...
                                  SizedBox(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Table(
                                          columnWidths: const {
                                            0: FlexColumnWidth(2.5),//ac
                                            1: FlexColumnWidth(2),//st
                                            2: FlexColumnWidth(2),//co
                                            3: FlexColumnWidth(2),//cu
                                            4: FlexColumnWidth(2),//num
                                            5: FlexColumnWidth(1),//prd
                                            6: FlexColumnWidth(1),//it
                                            7: FlexColumnWidth(1),//amt
                                            8: FlexColumnWidth(1),//va
                                            9: FlexColumnWidth(1),//q
                                          },
                                          border: TableBorder(
                                            horizontalInside:BorderSide(width: 0.5, color: Colors.grey.shade400),
                                            verticalInside:BorderSide(width: 0.5, color: Colors.grey.shade400),
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Obx(()=> utils.selectHeatingType2("Total Orders",
                                              ""=="", (){
                                              }, Colors.blueAccent,productCtr.paginatedOrdersItems.length.toString().obs,width: 150),),10.width,
                                          Obx(()=> utils.selectHeatingType2("Total Value",
                                              ""=="", (){
                                              }, Colors.lightGreen,productCtr.formatAmount(productCtr.orderValue.value.toString()).obs,width: 250),),
                                        ],
                                      ),
                                      InkWell(
                                          onTap: (){
                          ...
                          children: [
                            Container(
                              ...
                              decoration: customDecoration.baseBackgroundDecoration(
                                  ...
                                  radius: 14,borderColor: Colors.grey.shade200
                              ),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _summaryRow(
                                      "Total Activities",
                                      repCtr.activeReport["total_activities"].toString(),width/15
                                  ),
                                  const Divider(height: 40,),
                                  _summaryRow(
                                      "Average Per Day",
                                      repCtr.activeReport["average_per_day"].toString(),width/15
                                  ),
                                  const Divider(height: 40,),
                                  _summaryRow(
                                      "Most Active Day",
                                      "${repCtr.activeReport["most_active_day"]}\n(${repCtr.activeReport["most_active_count"]} Activities)",width/15
                                  ),
                                ],
                              ),
                            )
