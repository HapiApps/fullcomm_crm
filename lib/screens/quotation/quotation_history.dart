                  ...
                  Obx(() =>
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            CustomAppbar(
                                text:"Quotation Details",subText: "View all quotation details",
                                                            ...
                                                            children: [
                                                              ...
                                                              InkWell(
                                                                ...
                                                                child: Padding(
                                                                  padding: const EdgeInsets
                                                                      .all(10.0),
                                                                  child: data.status == "Order Confirmed"?
                                                                  CustomText(text: "Order Confirmed", isCopy: false):
                                                                  Container(
                                                                    height: 40,
                                                                    padding: const EdgeInsets
                                                                        .symmetric(
                                                                      ...
                                                                      child: DropdownButton<
                                                                        ...
                                                                        onChanged: (value) {
                                                                          setState(() {
                                                                            ...
                                                                            if ((data.invoiceDate=="null"||data.invoiceDate=="")&& data.dropValue == "Create Invoice") {
                                                                            ...
                                                                            else if (data.invoiceDate!="null"&&data.invoiceDate!=""&& data.dropValue =="Create Invoice") {
                                                                              utils.snackBar(
                                                                                  context: context,
                                                                                  msg: "Already Invoice Sent",
                                                                                  color: Colors.red);
                                                                            }
                                                                            else if ((data.poNumber=="null"||data.poNumber=="")&&data.dropValue =="Upload PO") {
                                                                              ...
                                                                              utils.showDeleteDialog(
                                                                                  context: context, name: 'confirm this order',
                                                                                  isDelete: false,
                                                                                  callBack: (){
                            ...
                            Row(
                              ...
                              children: [
                                PaginationWidget(
                                  currentPage: productCtr.currentPage,
                                  totalPages:(productCtr.paginatedItems.length / productCtr.itemsPerPage).ceil(),
                                  onPageChanged: (page) {
                                    setState(() {
                                      productCtr.currentPage = page;
                                    });
                                  },
                                ),
                              ],
