...
void checkType(){
        ...
        body: Row(
          ...
          children: [
            ...
            Obx(()=>Container(
              ...
              child: controllers.isLeadLoading.value
                ...
                children: [
                  ...
                  20.height,
                  Expanded(
                    child: FutureBuilder<CustomerFullDetails>(
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Column(
                                                        crossAxisAlignment: CrossAxisAlignment.start,
                                                        children: [
                                                          CustomText(text: "History",isCopy: true,isBold: true,size: 17),
                                                          10.height,
            ...
            child: Row(
              children: [
                Container(
                  width: 40,height: 40,
                  decoration: customDecoration.baseBackgroundDecoration(
                    color: Color(0xFFDCFCE7),radius: 40
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(10),
                    child: Image.asset("assets/images/cus_detail/call.png"),
                  ),
                ),10.width,
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CustomText(text:"${c.callType ?? ''} - ${c.callStatus ?? ''}",isCopy: false,isBold: true,),
                    5.height,
                    Row(
                      children: [
  ...
  Widget _buildMailRecords(List<MailRecord> calls) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        10.height,
            ...
            child: Row(
              children: [
                Container(
                  width: 40,height: 40,
                  decoration: customDecoration.baseBackgroundDecoration(
                    color: Color(0xFFFCE7F3),radius: 40
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(10),
                    child: Image.asset("assets/images/cus_detail/mail.png"),
                  ),
                ),10.width,
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CustomText(text:c.subject ?? '',isCopy: false,isBold: true,),
                    // CustomText(text:c.message ?? '',isCopy: false,isBold: true,),
                    5.height,
                    Row(
                      children: [
            ...
            child: Row(
              children: [
                Container(
                  width: 40,height: 40,
                  decoration: customDecoration.baseBackgroundDecoration(
                      color: Color(0xFFDBEAFE),radius: 40
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(10),
                    child: Image.asset("assets/images/cus_detail/cal2.png"),
                  ),
                ),10.width,
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CustomText(text:"${m.title ?? ''} - ${m.status ?? ''}",isCopy: false,isBold: true,),
                    5.height,
                    Row(
                      children: [
                        CustomText(text:m.createdBy ?? "", size: 12,colors: Colors.grey,isCopy: false,),5.width,
                        CircleAvatar(radius: 2,backgroundColor: Colors.grey,),5.width,
                        CustomText(text:utils.formatDateTime(m.dates ?? "",m.time ?? ""), size: 12,colors: Colors.grey,isCopy: false,),
                      ],
                    ),
                  ],
                ),
            ...
            child: Row(
              children: [
                Container(
                  width: 40,height: 40,
                  decoration: customDecoration.baseBackgroundDecoration(
                      color: Color(0xFFFEF3CC),radius: 40
                  ),
                  child: Padding(
                    padding: const EdgeInsets.all(10),
                    child: Image.asset("assets/images/cus_detail/rem2.png"),
                  ),
                ),10.width,
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    CustomText(text:"${r.type.toString()=="1"?"Follow-up":"Appointment"} - ${r.title ?? ''}",isCopy: false,isBold: true,),
                    5.height,
                    CustomText(text:"${r.employee ?? ''} - ${r.startDt ?? ''}${r.endDt ?? ''}",isCopy: false),
                    5.height,
                    Row(
                      children: [
                        CustomText(text:r.createdBy ?? "", size: 12,colors: Colors.grey,isCopy: false,),5.width,
                        CircleAvatar(radius: 2,backgroundColor: Colors.grey,),5.width,
                        CustomText(text:controllers.formatDateTime(r.createdTs.toString()), size: 12,colors: Colors.grey,isCopy: false,),
                      ],
                    ),
                  ],
                ),
