                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children:[
                                                      ...
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("name") ??"Name"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("mobile_name") ??"Mobile No"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("email") ??"Email id"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("discussion_point") ??"Discussion Point"),color: colorsConst.headColor),
                                                    ],
                                                  ),
                                                  30.width,
                                                  Column(
                                                    ...
                                                    children:[
                                                      ...
                                                      20.height,
                                                      utils.leadText(text: leadData.emailId.toString()=="null"?"":leadData.emailId.toString().split("||")[0],color: colorsConst.textColor),
                                                      20.height,
                                                ...
                                                children:[
                                                  Column(
                                                    ...
                                                    children:[
                                                      ...
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("owner") ??"Account Manager"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "Whatsapp No",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "Quotation Required",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "Visit Type",color: colorsConst.headColor),
                                                    ],
                                                  ),
                                                  40.width,
                                                  Column(
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children:[
                                                      ...
                                                      20.height,
                                                      utils.leadText(text: "Door No",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "Area",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "State",color: colorsConst.headColor),
                                                    ],
                                                  ),
                                                  Column(
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children:[
                                                      ...
                                                      20.height,
                                                      utils.leadText(text: "Street",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "City",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "Country",color: colorsConst.headColor),
                                                    ],
                                                  ),
                                                  40.width,
                                                  Column(
                                                ...
                                                children:[
                                                  Column(
                                                    ...
                                                    children:[
                                                      ...
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("company_name") ??"Company Name"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "Company Phone No.",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "Industry",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "Linkedin",color: colorsConst.headColor),
                                                    ],
                                                  ),
                                                  10.width,
                                                  Column(
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children:[
                                                      ...
                                                      20.height,
                                                      utils.leadText(text: "Website",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "Company Email",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "Product/Services",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "X",color: colorsConst.headColor),
                                                    ],
                                                  ),
                                                  30.width,
                                                  Column(
                                                    ...
                                                    children:[
                                                      ...
                                                      20.height,
                                                      utils.leadText(text: widget.x.toString()=="null"?"":widget.x,color: colorsConst.textColor),
                                                    ],
                                                  ),
                                                ],
                                              ),
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children:[
                                                      ...
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("product_discussion") ??"Product Discussed"),color: colorsConst.headColor),
                                                      20.height,
                                                      // utils.leadText(text: "Details Of Services Required",color: colorsConst.headColor),
                                                      // 20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("status") ??"Status"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("expected_billing_value") ??"Expected Monthly Billing Value"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("num_of_headcount") ??"Total Number Of Head Count"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("details_of_service_required") ??"Details of Service Required"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("rating") ??"Prospect Grading"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("source_details") ??"PROSPECT SOURCE DETAILS"),color: colorsConst.headColor),
                                                    ],
                                                  ),
                                                  40.width,
                                                  Column(
                                                ...
                                                children: [
                                                  Column(
                                                    ...
                                                    children:[
                                                      ...
                                                      20.height,
                                                      utils.leadText(text: "Additional Notes",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: "Response Priority",color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("arpu_value") ??"ARPU Value"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("expected_convertion_date") ??"Expected Conversion Date"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("prospect_enrollment_date") ??"Prospect Enrollment Date"),color: colorsConst.headColor),
                                                      10.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("source") ??"SOURCE OF PROSPECT"),color: colorsConst.headColor),
                                                      20.height,
                                                      utils.leadText(text: _formatHeading(controllers.getUserHeading("status_update") ??"Status Update"),color: colorsConst.headColor),
                                                      25.height,
                                                    ],
                                                  ),
                                                  20.width,
                                            ...
                                            ...additionalInfoList.map((info) {
                                              ...
                                              return Padding(
                                                ...
                                                child: Row(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    utils.leadText(text: key, color: colorsConst.headColor),
                                                    10.width,
