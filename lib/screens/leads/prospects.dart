            ...
            child: Column(
              ...
              children: [
                Obx(()=>   RadioListTile<String>(
                  ...
                  groupValue: controllers.selectedProspectTemperature.value,
                  onChanged: (value) {
                    controllers.selectedProspectTemperature.value = value.toString();
                  },
                ),),
                Obx(()=>   RadioListTile<String>(
                ...
                Obx(()=>  RadioListTile<String>(
                  ...
                  groupValue: controllers.selectedProspectTemperature.value,
                  onChanged: (value) {
                    controllers.selectedProspectTemperature.value = "";
                  },
                ),),
                Row(
      ...
      child: Scaffold(
        ...
        body: Row(
          ...
          children:[
            ...
            Obx(()=>Container(
              width:controllers.isLeftOpen.value==false&&controllers.isRightOpen.value==false?MediaQuery.of(context).size.width-200:MediaQuery.of(context).size.width-490,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children:[
                      Obx(()=>   GroupButton(
                        ...
                        buttons: ["All ${controllers.leadCategoryList.isEmpty?"":controllers.leadCategoryList[1]["value"]} ${controllers.allLeadsLength.value}"],
                      ...
                      Row(
                        children: [
                          ...
                          DeleteButton(
                            ...
                            callback: () {
                              apiService.deleteCustomersAPI(context,apiService.qualifiedList);
                            },
                          ),
                          5.width,
                          Obx(()=>   PromoteButton(
                            headText: controllers.leadCategoryList[0]["value"],
                            leadList: apiService.qualifiedList,
                            callback: () {
                          ...
                          5.width,
                          Obx(()=>   PromoteButton(
                            headText: controllers.leadCategoryList[2]["value"],
                            leadList: apiService.qualifiedList,
                            callback: () {
                  ...
                  Row(
                    ...
                    children: [
                      Tooltip(
                        message: 'All the leads in the ${controllers.leadCategoryList[1]["value"]} will be selected',
                        child: TextButton(
                          onPressed: (){
                          ...
                          child: CustomText(
                            text: "Select All",
                            size: 16,
                            colors: controllers.isAllSelected.value?colorsConst.third:colorsConst.textColor,
                          ),
                        ),
                      )
                    ],
                            ...
                            itemBuilder: (context, index){
                              ...
                              return Center(
                                  child:LeadCon(
                                    ...
                                    status: data.leadStatus == null ? "UnQualified" : data.leadStatus.toString(),
                                    rating: data.rating == null ? "Warm" : data.rating.toString(),
