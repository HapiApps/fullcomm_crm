              ...
              child:Column(
                ...
                children:[
                  ...
                  Row(
                    ...
                    children:[
                      Column(
                        ...
                        children:[
                          Obx(()=>CustomText(
                            text: "Good Leads - ${controllers.leadCategoryList[2]["value"]}",
                          ...
                          10.height,
                          Obx(()=>CustomText(
                            text: "View all of your ${controllers.leadCategoryList[2]["value"]} Information",
                            colors: colorsConst.textColor,
                            size: 14,
                          ),),
                        ],
                      ...
                      Row(
                        ...
                        children: [
                          DeleteButton(
                            ...
                            callback: () {
                              apiService.deleteCustomersAPI(context,apiService.customerList);
                            },
                          ),
                          5.width,
                          Obx(()=>   PromoteButton(
                            ...
                            leadList: apiService.customerList,
                            callback: () {
                              apiService.insertProspectsAPI(context,apiService.customerList);
                            },
                            text: "Demote",
                          ),),
                          5.width,
                  ...
                  Row(
                    ...
                    children:[
                      Tooltip(
                        message: 'All the leads in the prospects will be selected',
                        child: TextButton(
                          onPressed: (){
