                      ...
                      builder:(context, snapshot){
                        if(snapshot.hasData){
                          ...
                          var filteredData = originalData.where((item){
                            return item.firstname.toString().toLowerCase().contains(controllers.searchText.toLowerCase()) ||
                                item.companyName.toString().toLowerCase().contains(controllers.searchText.toLowerCase());
                          }).toList();
                          ...
                          return ScrollbarTheme(
                            data: ScrollbarThemeData(
                              thumbColor: MaterialStateProperty.all(const Color(0xff2C3557)), // 👈 Your color
                                              ...
                                              children:[
                                                Row(
                                                  ...
                                                  children:[
                                                    70.height,
                                                    10.width,
                                                    SvgPicture.asset("assets/images/paper.svg",width: 13,height: 13,),
                                                    10.width,
                                                    // Obx(() =>  CustomCheckBox(
                                                    //     text: "",
                                                    //     onChanged: (value){
                                                    ...
                                                    Container(
                                                      ...
                                                      child: CustomText(
                                                        ...
                                                        text:filteredData[index].quotationUpdate.toString().isEmpty||filteredData[index].quotationUpdate==null||filteredData[index].quotationUpdate=="null"?
                                                        "Not Sent":filteredData[index].quotationUpdate.toString(),
                                                ...
                                                Padding(
                                                  ...
                                                  child: CustomText(
                                                    textAlign: TextAlign.center,
                                                    text:filteredData[index].firstname.toString().split("||")[0],
                                                    size: 14,
                                                    colors: colorsConst.textColor,
                                                  ),
                                                ),
                                                Padding(
                                                  ...
                                                  child: CustomText(
                                                    textAlign: TextAlign.center,
                                                    text: filteredData[index].mobileNumber.toString().split("||")[0],
                                                    size: 14,
                                                    colors: colorsConst.textColor,
                                                  ),
                                                ),
                                                ...
                                                Padding(
                                                  ...
                                                  child: CustomText(
                                                    textAlign: TextAlign.center,
                                                    text:filteredData[index].emailId.toString()=="null"?"":filteredData[index].emailId.toString().split("||")[0],
                                                    size: 14,
                                                    colors:colorsConst.textColor,
                                                  ),
                                                ),
                                                Padding(
                                                  ...
                                                  child: CustomText(
                                                    textAlign: TextAlign.center,
                                                    text:filteredData[index].city.toString()=="null"?"":filteredData[index].city.toString(),
                                                    size: 14,
                                                    colors:colorsConst.textColor,
                                                  ),
                                                ),
                                                Padding(
                                                  ...
                                                  child: CustomText(
                                                    textAlign: TextAlign.center,
                                                    text:filteredData[index].companyName.toString(),
                                                    size: 14,
                                                    colors:colorsConst.textColor,
                                                  ),
                                                ),
                                                ...
                                                Padding(
                                                  ...
                                                  child: Center(
                                                    child: Container(
                                                      ...
                                                      height: 20,
                                                      decoration: BoxDecoration(
                                                          color:const Color(0xffFEDED8),
                                                          borderRadius: BorderRadius.circular(10),
                                                          border: Border.all(
                                                              color:const Color(0xffFE5C4C)
                                                          )
                                                      ),
                                                      alignment: Alignment.center,
                                                      child: CustomText(
                                                        text:filteredData[index].rating==null?"Warm":filteredData[index].rating.toString(),
                                                        colors:const Color(0xffFE5C4C),
                                                        size: 12,
                                                        isBold: true,
                                                      ),
                                                    ),
