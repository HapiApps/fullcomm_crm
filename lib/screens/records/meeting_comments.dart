              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Obx(()=>remController.selectedMeetingIds.isNotEmpty?
                    Row(
                      children: [
                        CustomText(text: "Selected count: ${remController.selectedMeetingIds.value.length}", isCopy: false),15.width,
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child:  Row(
                              ...
                              children: [
                                Image.asset("assets/images/action_promote.png"),
                                10.width,
                                CustomText(
                                  text: "Status",
                                  colors: colorsConst.textColor,
                      ...
                      TableRow(
                          ...
                          children: [
                            headerCell(0, Obx(() => Checkbox(
                              ...
                              value: remController.selectedMeetingIds.length == remController.meetingFilteredList.length,
                              onChanged: (value) {
                                setState(() {
                                  if (value == true) {
                            ...
                            headerCell(5,  Row(
                              children: [
                                ...
                                GestureDetector(
                                  onTap: (){
                                    if(controllers.sortFieldMeetingActivity.value=='status' && controllers.sortOrderMeetingActivity.value=='asc'){
                                      controllers.sortOrderMeetingActivity.value='desc';
                                    }else{
                                      controllers.sortOrderMeetingActivity.value='asc';
                                    }
                                            ...
                                            IconButton(
                                                onPressed: (){
                                                  setState(() {
                                                    ...
                                                    controllers.selectedCustomerName.value = data.cusName.toString();
                                                    controllers.selectedCompanyName.value = data.comName;
                                                    controllers.meetingTitleCrt.text = data.title.toString()=="null"?"":data.title.toString();
                                                    controllers.meetingVenueCrt.text = data.venue.toString()=="null"?"":data.venue.toString();
                                                    controllers.fDate.value = data.dates.toString().split("||").first;
                                                    controllers.toDate.value = data.dates.toString().split("||").last;
                                                    controllers.toTime.value = data.time.toString().split("||").first;
                                                    controllers.fTime.value = data.time.toString().split("||").last;
                                                  ...
                                                  // remController.updateStartController.text = data.startDt.toString()=="null"?"":data.startDt.toString();
                                                  // remController.updateEndController.text = data.endDt.toString()=="null"?"":data.endDt.toString();
