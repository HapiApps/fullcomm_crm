                            ...
                            return InkWell(
                              ...
                              child: Row(
                                children: [
                                  CustomText(
                                    text: item["value"],
                                    colors: controllers.selectCallType.value == item["value"] ? colorsConst.primary : colorsConst.textColor,
                                    isBold: true,
                                    size: 15,
                                    isCopy: false,
                                  ),
                                  ...
                                  CircleAvatar(
                                    backgroundColor:
                                    controllers.selectCallType.value == item["value"] ? colorsConst.primary : colorsConst.secondary,
                                    radius: 15,
                                    child: CustomText(
                                      text: item["count"].toString(),
                                      colors: controllers.selectCallType.value == item["value"] ? Colors.white : colorsConst.primary,
                                      size: 15,
                                      isCopy: false,
                                    ),
                                  ),
                                  10.width,
                                  item.length == controllers.hCallStatusList.last.length
                                      ? 0.height
                                      : Container(
                                    width: 1,
                                    height: 22,
