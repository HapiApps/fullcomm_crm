...
class InvoiceViewPrint extends StatefulWidget {
  final Order data;
  const InvoiceViewPrint({super.key, required this.data});

  @override
  State<InvoiceViewPrint> createState() => _InvoiceViewPrintState();
}

class _InvoiceViewPrintState extends State<InvoiceViewPrint> {
  @override
  Widget build(BuildContext context) {
    return Screenshot(
      controller: productCtr.screenshotController,
      child: Scaffold(
        body: SingleChildScrollView(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    ...
                    child: Column(
                      ...
                      children: [
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        children: [
                                          CustomText(text: widget.data.orderId, isCopy: false,colors: colorsConst.primary,size: 18),5.height,
                                          CustomText(text: DateFormat('d MMM yyyy').format(DateTime.now()), isCopy: false,colors: colorsConst.primary,size: 18),5.height,
                                          CustomText(text: widget.data.orderId, isCopy: false,colors: colorsConst.primary,size: 18),
                                        ],
                                      )
                                    ],
                                  ),
                        ...
                        Row(
                          children: [
                            CustomText(text: "M/S : ", isCopy: true,colors: colorsConst.primary,size: 18),
                            CustomText(text: widget.data.customerName, isCopy: true,colors: colorsConst.primary,size: 18),
                          ],
                        ), Row(
                          children: [
                            CustomText(text: "Address : ", isCopy: true,colors: colorsConst.primary,size: 18),
                            CustomText(text: widget.data.address, isCopy: true,colors: colorsConst.primary,size: 18),
                          ],
                        ),
                        CustomText(text: "\nPARTY GSTIN : ", isCopy: true,colors: colorsConst.primary,size: 18),
                        _buildLineItemsTable(),
    ...
    return Table(
      ...
      children: [
        ...
        ...List.generate(widget.data.products.length, (index) {
          final row = widget.data.products[index];
