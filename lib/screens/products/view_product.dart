                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        ...
                        children:[
                          ...
                          20.height,
                        Obx(() =>   CustomText(
                          text: "Products(${controllers.allProductLength.value})",
                                    ...
                                    InkWell(
                                      onTap:(){
                                        Navigator.push(context,
                                          PageRouteBuilder(
                                            pageBuilder: (context, animation1, animation2) => const TFSAddProducts(),
                                      ...
                                      child: MouseRegion(
                                        ...
                                        child: Obx(() => CustomText(
                                          text: "Add Product",
                                          decoration: controllers.isAdd.value?TextDecoration.underline:TextDecoration.none,
                                          colors: colorsConst.primary,
                                          size: 20,
                                        ),)
                                      ),
                                                ...
                                                content:SizedBox(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                     ...
                                                     const CustomText(
                                                       text: "THIRUMAL FACILITIES SERVICE",
                                                       isBold: true,
                                                       colors: Colors.black,
                                                       size: 16,
                                                     ),
                                ...
                                if(snapshot.hasData){
                                  return ListView.builder(
                                      ...
                                      itemBuilder:(context, index){
                                        if (snapshot.data![index].name.toString().toLowerCase().contains(controllers.searchText.toLowerCase())){
                                          return CustomProductTile(
                                              productName:snapshot.data![index].name.toString(),
                                              brand:snapshot.data![index].brand.toString(),
                                              comparePrice:snapshot.data![index].comparePrice.toString(),
                                              discountPrice: snapshot.data![index].discount.toString(),
                                              productPrice: snapshot.data![index].productPrice.toString());
                                        }
                                  ...
                                  return const Center(child: CustomText(text: "No Products"));
                                }
