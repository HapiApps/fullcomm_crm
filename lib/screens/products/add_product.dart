                                      ...
                                      Column(
                                        ...
                                        children:[
                                          CustomTextField(
                                            ...
                                            text:"Product Name",
                                            controller: controllers.prodNameController,
                                            width:textFieldSize,
                                            ...
                                            onChanged:(value) async {
                                              ...
                                              sharedPref.setString("productName", value.toString().trim());
                                            },
                                            // validator:(value){
                                          ...
                                          CustomTextField(
                                            ...
                                            onChanged:(value) async {
                                              SharedPreferences sharedPref = await SharedPreferences.getInstance();
                                              sharedPref.setString("productCategory", value.toString().trim());
                                            },
                                            // validator:(value){
                                            //   if(value.toString().isEmpty){
                                            //     return "This field is required";
                                          ...
                                          CustomTextField(
                                            ...
                                            onChanged:(value) async {
                                              SharedPreferences sharedPref = await SharedPreferences.getInstance();
                                              sharedPref.setString("comparePrice", value.toString().trim());
                                            },
                                            // validator:(value){
                                            //   if(value.toString().isEmpty){
                                            //     return "This field is required";
                                          ...
                                          CustomTextField(
                                            ...
                                            onChanged:(value) async {
                                              SharedPreferences sharedPref = await SharedPreferences.getInstance();
                                              sharedPref.setString("productPrice", value.toString().trim());
                                            },
                                            // validator:(value){
                                            //   if(value.toString().isEmpty){
                                            //     return "This field is required";
                                          ...
                                          CustomTextField(
                                            hintText:"Net Price",
                                            text:"Net Price",
                                            controller: controllers.netPriceController,
                                            width:textFieldSize,
                                            keyboardType: TextInputType.text,
                                            ...
                                            onChanged:(value) async {
                                              SharedPreferences sharedPref = await SharedPreferences.getInstance();
                                              sharedPref.setString("netPrice", value.toString().trim());
                                            },
                                            // validator:(value){
                                            //   if(value.toString().isEmpty){
                                            //     return "This field is required";
                                          ...
                                          CustomTextField(
                                            ...
                                            text:"HSN/SAN Code",
                                            controller: controllers.hsnController,
                                            width:textFieldSize,
                                            keyboardType: TextInputType.text,
                                            ...
                                            onChanged:(value) async {
                                              SharedPreferences sharedPref = await SharedPreferences.getInstance();
                                              sharedPref.setString("hsnController", value.toString().trim());
                                            },
                                            // validator:(value){
                                            //   if(value.toString().isEmpty){
                                            //     return "This field is required";
                                      ...
                                      Column(
                                        ...
                                        children:[
                                          ...
                                          CustomTextField(
                                            hintText:"Brand",
                                            text:"Brand",
                                            controller: controllers.prodBrandController,
                                            width:textFieldSize,
                                            keyboardType: TextInputType.text,
                                            ...
                                            onChanged:(value) async {
                                              SharedPreferences sharedPref = await SharedPreferences.getInstance();
                                              sharedPref.setString("productBrand", value.toString().trim());
                                            },
                                            // validator:(value){
                                            //   if(value.toString().isEmpty){
                                            //     return "This field is required";
                                          ...
                                          40.height,
                                          CustomDropDown(
                                            saveValue: controllers.subCategory,
                                            ...
                                            onChanged:(value) async {
                                              setState(() {
                                                controllers.subCategory= value;
                                              });
                                              SharedPreferences sharedPref = await SharedPreferences.getInstance();
                                              sharedPref.setString("subCategory", value.toString().trim());
                                            },
                                            // validator:(value){
                                            //   if(value.toString().isEmpty){
                                            //     return "This field is required";
                                          ...
                                          CustomTextField(
                                            ...
                                            onChanged:(value) async {
                                              SharedPreferences sharedPref = await SharedPreferences.getInstance();
                                              sharedPref.setString("discountOnMRP", value.toString().trim());
                                            },
                                            // validator:(value){
                                            //   if(value.toString().isEmpty){
                                            //     return "This field is required";
                                          ...
                                          CustomDropDown(
                                            ...
                                            onChanged:(value) async {
                                              ...
                                              SharedPreferences sharedPref = await SharedPreferences.getInstance();
                                              sharedPref.setString("tax", value.toString().trim());
                                            },
                                            // validator:(value){
                                            //   if(value.toString().isEmpty){
                                            //     return "This field is required";
                                          ...
                                          CustomTextField(
                                            ...
                                            onChanged:(value) async {
                                              SharedPreferences sharedPref = await SharedPreferences.getInstance();
                                              sharedPref.setString("discount", value.toString().trim());
                                            },
                                            // validator:(value){
                                            //   if(value.toString().isEmpty){
                                            //     return "This field is required";
                                          ...
                                          CustomDropDown(
                                            ...
                                            valueList: controllers.topProductList,
                                            text:"Mark as top\n product(Optional)",
                                            width:textFieldSize,
                                            ...
                                            onChanged:(value) async {
                                              setState(() {
                                                controllers.topProduct= value;
                                              });
                                              SharedPreferences sharedPref = await SharedPreferences.getInstance();
                                              sharedPref.setString("topProduct", value.toString().trim());
                                            },
                                            // validator:(value){
                                            //   if(value.toString().isEmpty){
                                            //     return "This field is required";
                                      ...
                                      Column(
                                        ...
                                        children:[
                                          CustomTextField(
                                            ...
                                            onChanged:(value) async {
                                              SharedPreferences sharedPref = await SharedPreferences.getInstance();
                                              sharedPref.setString("productDescription", value.toString().trim());
                                            },
                                            // validator:(value){
                                            //   if(value.toString().isEmpty){
                                            //     return "This field is required";
