...
//                         constraints: BoxConstraints(minWidth: controllers.isLeftOpen.value?MediaQuery.of(context).size.width - 150:MediaQuery.of(context).size.width - 60), // 👈 must
//                         child: SizedBox(
//                           width: controllers.isLeftOpen.value?MediaQuery.of(context).size.width - 150:MediaQuery.of(context).size.width - 60,
//                           // width: controllers.isLeftOpen.value?MediaQuery.of(context).size.width - 150:MediaQuery.of(context).size.width - 60,
//                           child: Table(
...
//                   Expanded(
//                       child: Obx((){
//                         return productCtr.products.isEmpty?
//                         Container(
...
//                               }
//
//                               /// ➡ RIGHT (horizontal) ✅ FIX
//                               else if (event.logicalKey == LogicalKeyboardKey.arrowRight) {
//                                 _horizontalController.animateTo(
//                                   _horizontalController.offset + 150,
//                                   duration: const Duration(milliseconds: 150),
//                                   curve: Curves.easeInOut,
//                                 );
//                               }
