...
class _NewBillingScreenState extends State<NewBillingScreen> {
  ...
  // Future<void> saveCustomerAndClose(BuildContext context,
  //     FocusNode dropdownFocusNode,) async {
  //   final billingProvider = Provider.of<BillingProvider>(
  //       context, listen: false);
  //   String name = billingProvider.nameController.text.trim();
  //   String mobile = billingProvider.mobileController.text.trim();
  //
  ...
  // Future<void> handleTypedCustomer(BuildContext context,
  //     String typed,
  //     String nameInput,)
  // async {
  ...
  //       .trim()
  //       .isEmpty ? "Customer" : nameInput.trim();
  //   String mobile = typed.trim();
  //
  //   if (mobile.length != 10 || int.tryParse(mobile) == null) {
  //     Toasts.showToastBar(
  //       context: context,
  //       text: "Enter a valid 10-digit mobile",
  //       color: Colors.red,
  //     );
  //     return;
  //   }
  //
  //   final String newCustomerId = await customerProvider.addCustomer(
  //     context: context,
  //     name: name,
  //     mobile: mobile,
  //     addressLine1: "",
  ...
  //
  //   final savedCustomer = customerProvider.allCustomersList.firstWhere(
  //         (c) => c.mobile == mobile,
  //     orElse: () =>
  //         CustomerData(
  ...
  //     customerName: savedCustomer.name.toString(),
  //     customerMobile: savedCustomer.mobile.toString(),
  //     customerAddress: "",
  //   );
  // }
                              ...
                              children: [
                                ...
                                AppBar(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: FittedBox(
                                                    fit: BoxFit.cover,
                                                    child: Image.asset('assets/images/bill/Martway.png'),
                                                  ),
                                                ),
                                              ),
                                  ...
                                  actions: [
                                    ...
                                    //         context: context,
                                    //         toolTip: 'Reset Current Bill',
                                    //         icon: 'assets/images/bill/Reset.svg',
                                    //         onPressed: () {
                                    //           billingProvider.clearBillingData(context);
                                    //         },
                                    //       ),
                                    //       MyText(text: "Reset Bill (Delete)",fontWeight: FontWeight.bold,fontSize: 17,)
                                    //     ],
                                    //   ),
                                    // ),
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                              // ICON
                                              SvgPicture.asset(
                                                "assets/images/bill/release_bill.svg",
                                                height: 30,
                                              ),
                                              const SizedBox(width: 2),
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                              // ICON
                                              SvgPicture.asset(
                                                "assets/images/bill/customer.svg",
                                                height: 30,
                                              ),
                                              const SizedBox(width: 2),
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                              // ICON
                                              SvgPicture.asset(
                                                "assets/images/bill/Refresh.svg",
                                                height: 30,
                                              ),
                                              const SizedBox(width: 2),
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                              border: Border.all(
                                                  color: Colors.black26),
                                              color: Colors
                                                  .white // color: AppColors.primaryGreen.withOpacity(0.2)
                                          ),
                                          child: Row(
                                            children: [
                                              // ICON
                                              SvgPicture.asset(
                                                "assets/images/bill/logout.svg",
                                                height: 30,
                                              ),
                                              const SizedBox(width: 2),
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                MyText(
                                                  text: "Cashier Code- ${controllers.storage.read("id")}",
                                                  fontSize: 26,
                                                  fontWeight: FontWeight.bold,
                                                ),
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            border: Border.all(
                                              color: Colors.black, // ✅ outline black
                                              width: 1.5,
                                            ),
                                          ),
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Checkbox(
                                                value: billingProvider.isWChecked,
                                                onChanged: (val) async {
                                                  billingProvider.setWChecked(val ?? false);

                                                  if (billingProvider.isWChecked) {
                                                    await billingProvider.getWholeSaleProducts();
                                                  } else {
                                                    await billingProvider.getProducts();
                                                  }
                                                },
                                              ),
                                            ],
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: SizedBox.expand(
                                                    child: MyDropdownMenu2<CustomerData>(
                                                      ...
                                                      //
                                                      //   final highlighted =
                                                      //       (cusDropdownKey.currentState as dynamic)
                                                      //           ?.highlightedValue;
                                                      //
                                                      //   if (highlighted != null) {
                                                      //     (cusDropdownKey.currentState as dynamic)
                                                      ...
                                                      //
                                                      //   if (matches.isEmpty) {
                                                      //     showAddCustomerPopup(context, q);
                                                      //     return;
                                                      //   }
                                                      //
                                                      //   if (matches.length == 1) {
                                        ...
                                        Expanded(
                                          ...
                                          child: Container(
                                            ...
                                            child: MyText(
                                              text: customerProvider.customerAddressController.text.isEmpty
                                                  ? "Cust. Address"
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: billingProvider.billingItems.isNotEmpty
                                                ...
                                                context,
                                                image: 'assets/images/bill/empty_bill.png',
                                                text: '',
                                              ),
                                            ),
                                          ],
